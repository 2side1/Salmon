...
var possibleInput = {
  "help" : function(){
    ...
    responseText("Something like &quot;Morton, please show me Micheal&rsquo; best work&quot;")
    responseText("Did you find a bug or problem? Tweet me @MichealRu")
    commandReset(0);
    return
    },
  "best work" : function(){
    responseText("I will show you Micheal' best work!");
  ...
  "about" : function(){
    responseText("This is me, Morton's maker, Micheal Rutten");
    //Outputs an image
    responseImg("rsz_Michealface.jpg");
    ...
    responseText("Would you like to know about Micheal' vision? (Yes/No)");
    commandReset(2);
    return
    },
  "experience" : function(){
    ...
    responseText("Would you like to see Micheal' CV? (Yes/No)");
    commandReset(3);
    return
  },
  "hobbies" : function(){
    responseText("Micheal loves:");
  ...
  "cv" : function(){
    responseText("I will redirect you to Micheal' CV");
    //Redirects you to an image
    setTimeout(function(){
      window.location.href = "/images/CV-MichealRutten-2017-februari.png"; }, 3000);
    commandReset(6);
    return
  },
  "vision" : function(){
  ...
  "contact" : function(){
    responseText("email: <a href='mailto:Michealrutten@gmail.com?Subject=Hello%20Micheal' target='_top'>send me a message</a>");
    responseText("Twitter: <a href='https://twitter.com/Michealrttn'>@MichealRttn</a>");
    commandReset(8);
    return
  },
  "commands" : function(){
...
var reactionInput = {
  "best work" : function(){
    ...
    responseText("<a href='https://github.com/Michealrutten/chatbot'>Morton on GitHub</a>")
    animationCounter = 1;
    return
  },
  "about" : function(){
